	...
	<div class="position-relative">
		...
		<div id="list-item-3" class="position-relative">
			<transition-group tag="div" class="position-relative" name="slide-fade">
				<div class="card mb-2 bg-light border-0 position-relative" style="border-radius: 1rem;" v-for="guru in items" :key="guru.id_guru">
					<div class="card-body">
						<div class="row g-0">
							<div class="col" style="max-width: 4rem;">
								<div class="foto-profil flex-grow-1 d-flex flex-column justify-content-center align-items-center" style="height: 3rem; width: 3rem; background: #0001; background-size: cover; background-position: center" v-if="guru.foto && guru.foto.url" :style="{'background-image': `url('${guru.foto.url}')`}">
								</div>
								<div class="foto-profil flex-grow-1 d-flex flex-column justify-content-center align-items-center" style="height: 3rem; width: 3rem; background: #0001" v-else>
