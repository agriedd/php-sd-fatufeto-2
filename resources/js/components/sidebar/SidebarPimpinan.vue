		...
		<v-list dense nav>
			<v-list-item dense link color="primary" :to="{ name: 'dashboard' }" exact>
				...
				<v-list-item-content>
					...
					<v-list-item-subtitle v-text="'Halaman awal Dashboard'" />
				</v-list-item-content>
			</v-list-item>
...
import SidebarPimpinanHeader from './SidebarPimpinanHeader.vue'
export default {
    components: { 
        SidebarPimpinanHeader 
    },
	computed: {
        ...mapGetters({
