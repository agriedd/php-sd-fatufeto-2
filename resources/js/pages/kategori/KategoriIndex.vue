                                            ...
                                            <div class="d-flex w-100">
                                                ...
                                                <v-menu open-on-click content-class="shadow-sm rounded-lg" :close-on-content-click="false">
                                                    ...
                                                    <v-list nav>
                                                        ...
                                                        <v-list-item dense link :to="{ name: 'kategori.show', params: { id_guru: item.id_guru }}">
                                                            <v-list-item-icon>
                                                        ...
                                                        <v-list-item dense link @click="ubahInfoKategori(item.id_guru)">
                                                            <v-list-item-icon>
                                                        ...
                                                        <v-list-item dense link @click="hapusInfoKategori(item.id_guru)">
                                                            <v-list-item-icon>
...
export default {
    ...
    methods: {
        ...mapMutations({
            showTambahDialog: 'kategori/SET_MODAL_TAMBAH',
        }),
        ...mapActions({
        ...
        async loadItems(){
            ...
            let res = await this.getItems({
                ...
                console.log("loadItem@KategoriIndex.vue", e);
            });
            this.loading = false
            if(res?.data?.data){
