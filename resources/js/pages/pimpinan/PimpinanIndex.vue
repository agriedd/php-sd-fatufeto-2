                ...
                <div v-else style="position: relative">
                    <v-expand-transition>
                        <div class="d-grid-sekolah" v-if="show">
                            <v-card color="indigo lighten-5 overflow-hidden" rounded="xl" flat link :to="{ name: 'pimpinan.list' }">
                                <v-card-text>
                                            ...
                                            <div class="d-flex w-100">
                                                ...
                                                <v-menu open-on-click content-class="shadow-sm rounded-lg" :close-on-content-click="false">
                                                    ...
                                                    <v-list nav>
                                                        ...
                                                        <v-list-item dense link @click="ubahInfoPimpinan(item.id_guru)">
                                                            <v-list-item-icon>
                                                        ...
                                                        <v-list-item dense link @click="hapusInfoPimpinan(item.id_guru)">
                                                            <v-list-item-icon>
...
export default {
    ...
    methods: {
        ...mapMutations({
            showTambahDialog: 'pimpinan/SET_MODAL_TAMBAH',
        }),
        ...mapActions({
