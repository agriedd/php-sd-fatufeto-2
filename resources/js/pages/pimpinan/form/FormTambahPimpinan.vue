    ...
    <div>
        ...
        <div class="d-grid-form">
            ...
            <v-text-field
                ...
                label="Password"
                :messages="[
                    'kata sandi akan menggunakan tanggal lahir guru dengan format [Tahun][Bulan][Tanggal], atau jika tanpa tanggal lahir password defaultnya adalah `password`'
                ]"
                readonly/>
        </div>
    </div>
