    ...
    actions: {
        get(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('v1/berita'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        count(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('v1/analytic/berita/count'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async show(context, {data = {}, id}){
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.get(api(`v1/berita/${id}`), { params: data }).catch(e => reject(e))
                    if(res) resolve(res)
                })
            else
                console.warn("show@berita.js", "id kosong 🤦‍♂️");
        },
        store(context, data){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.post(api('v1/berita'), data).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async update(context, { data, id }){
            if(id){
                ...
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.post(api(`v1/berita/${id}`), data).catch(e => reject(e))
                    if(res) resolve(res)
                })
            }
            else
                console.warn("update@berita.js", "id kosong 🤦‍♂️");
        },
        async destroy(context, { data, id }){
            if(id){
                ...
                console.warn("destroy@berita.js", "id kosong 🤦‍♂️");
        },
