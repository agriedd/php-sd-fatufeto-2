    ...
    actions: {
        get(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('v1/prasarana'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        count(context, params = {}){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.get(api('v1/analytic/prasarana/count'), { params: params }).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async show(context, {data = {}, id}){
            if(id)
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.get(api(`v1/prasarana/${id}`), { params: data }).catch(e => reject(e))
                    if(res) resolve(res)
                })
            else
        ...
        store(context, data){
            return new Promise(async(resolve, reject)=>{
                let res = await axios.post(api('v1/prasarana'), data).catch(e => reject(e))
                if(res) resolve(res)
            })
        },
        async update(context, { data, id }){
            if(id){
                ...
                return new Promise(async(resolve, reject)=>{
                    let res = await axios.post(api(`v1/prasarana/${id}`), data).catch(e => reject(e))
                    if(res) resolve(res)
                })
            }
            else
